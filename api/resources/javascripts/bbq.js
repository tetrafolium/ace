 ...
 */
(function($, p) {
var i, m = Array.prototype.slice, r = decodeURIComponent, a = $.param, c, l, v,
       b = $.bbq = $.bbq || {}, q, u, j, e = $.event.special, d = "hashchange",
       A = "querystring", D = "fragment", y = "elemUrlAttr", g = "location",
       k = "href", t = "src", x = /^.*\?|#.*$/g, w = /^.*\#/, h, C = {};
...
$.deparam = l = function(I, F) {
  ...
  $.each(I.replace(/\+/g, " ").split("&"), function(L, Q) {
    var K = Q.split("="), P = r(K[0]), J, O = H, M = 0, R = P.split("]["),
        N = R.length - 1;
...
b.getState = u = function(
    F, G) { return F === i || typeof F === "boolean" ? v(F) : v(G)[F] };
 ...
 */
(function($, i, b) {
var j, k = $.event.special, c = "location", d = "hashchange", l = "href",
