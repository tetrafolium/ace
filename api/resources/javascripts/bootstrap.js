          ...
          Dropdown.prototype =
              {
                ...
                keydown : function(e) {
                  ...
                  if (!isActive ||
                      (isActive && e.keyCode == 27)) return $this.click()
              ...
              function
              clearMenus() { getParent($(toggle)).removeClass('open') }
...
!function($) {
  ...
  var Affix =
    ...
    this.options = $.extend({}, $.fn.affix.defaults, options) this.$window =
        $(window)
            .on('scroll.affix.data-api',
                $.proxy(this.checkPosition, this)) this.$element =
            $(element) this.checkPosition()
  }
