 ...
 * from now on in days or a Date object. If a negative value is specified (e.g.
 * a date in the past), the cookie will be deleted. If set to null or omitted,
 * the cookie will be a session cookie and will not be retained when the the
 * browser exits.
 * @option String path The value of the path attribute of the cookie (default:
...
jQuery.cookie = function(name, value, options) {
  if (typeof value != 'undefined') { // name and value given, set cookie
    ...
    if (options.expires &&
      ...
      expires =
          '; expires=' + date.toUTCString(); // use expires attribute, max-age
