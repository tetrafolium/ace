define(function(require, exports, module) {
  ...
  exports.handler.addCommands([
    ...
    },
    {
      ...
      exec : function(editor) { editor.selectMore(1, true, true); },
      scrollIntoView : "animate",
      readOnly : true
    },
    {
      ...
      exec : function(editor) {
        ...
        editor.session.remove({start : {row : pos.row, column : 0}, end : pos});
      },
    ...
    },
    {
      ...
      exec : function(editor) {
        ...
        editor.session.remove(
            {start : pos, end : {row : pos.row, column : Infinity}});
      },
      multiSelectAction : "forEach",
      scrollIntoView : "cursor"
    },
    ...
    },
    {
      ...
      exec : function(editor) { moveBySubWords(editor, 1, true); },
      multiSelectAction : "forEach",
      scrollIntoView : "cursor",
      readOnly : true
    },
    ...
    },
    {
      ...
      exec : function(editor) { moveBySubWords(editor, 1); },
      multiSelectAction : "forEach",
      scrollIntoView : "cursor",
      readOnly : true
    },
  ...
  [{
   ...
   {bindKey : {mac : "cmd-alt-]", win : "ctrl-shift-]"}, name : "unfold"}, {
     bindKey :
         {mac : "cmd-k cmd-0|cmd-k cmd-j", win : "ctrl-k ctrl-0|ctrl-k ctrl-j"},
     name : "unfoldall"
   },
   {
   ...
   {
     bindKey :
         {mac : "ctrl-alt-shift-left|ctrl-shift-left", win : "alt-shift-left"},
     name : "selectSubWordLeft"
   },
   {
   ...
   {
     bindKey :
         {linux : "alt-shift-up", mac : "ctrl-shift-up", win : "ctrl-alt-up"},
     name : "addCursorAbove"
   },
