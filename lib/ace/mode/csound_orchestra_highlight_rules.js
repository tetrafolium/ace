define(function(require, exports, module) {
  ...
  var CsoundOrchestraHighlightRules = function(embeddedRulePrefix) {
    ...
    /*
      curl --remote-name --show-error --silent
      https://raw.githubusercontent.com/pygments/pygments/master/pygments/lexers/_csound_builtins.py
      python -c "import json; from _csound_builtins import OPCODES,
      DEPRECATED_OPCODES; print('var opcodes
      = {};'.format(json.dumps(sorted(list(OPCODES)), indent=4))); print('var
      deprecatedOpcodes
      = {};'.format(json.dumps(sorted(list(DEPRECATED_OPCODES)), indent=4)))"
    */
    ...
    var deprecatedOpcodes = [
      "array",     "bformdec",  "bformenc",  "changed",   "copy2ftab",
      "copy2ttab", "hrtfer",    "ktableseg", "lentab",    "maxtab",
      "mintab",    "pop",       "pop_f",     "ptable",    "ptable3",
      "ptablei",   "ptableiw",  "push",      "push_f",    "scalet",
      "sndload",   "soundout",  "soundouts", "specaddm",  "specdiff",
      "specdisp",  "specfilt",  "spechist",  "specptrk",  "specscal",
      "specsum",   "spectrum",  "stack",     "sumtab",    "tabgen",
      "tableiw",   "tabmap",    "tabmap_i",  "tabslice",  "tb0",
      "tb0_init",  "tb1",       "tb10",      "tb10_init", "tb11",
      "tb11_init", "tb12",      "tb12_init", "tb13",      "tb13_init",
      "tb14",      "tb14_init", "tb15",      "tb15_init", "tb1_init",
      "tb2",       "tb2_init",  "tb3",       "tb3_init",  "tb4",
      "tb4_init",  "tb5",       "tb5_init",  "tb6",       "tb6_init",
      "tb7",       "tb7_init",  "tb8",       "tb8_init",  "tb9",
      "tb9_init",  "vbap16",    "vbap4",     "vbap4move", "vbap8",
      "vbap8move", "xyin"
    ];
    ...
    start.splice(1, 0, {
      token : [
        "text.csound", "entity.name.label.csound",
        "entity.punctuation.label.csound", "text.csound"
      ],
      regex : /^([ \t]*)(\w+)(:)([ \t]+|$)/
    });
    start.push(
    ...
    this.addRules({
      ...
      "quoted string" : [
        this.popRule(
            {token : "punctuation.definition.string.end.csound", regex : /"/}),
      ...
      "goto before argument" :
          [ this.popRule({token : "text.csound", regex : /,/}), start ],
      "goto before label" : [
    ...
    this.embedRules(scoreHighlightRules.getRules(),
                    scoreHighlightRules.embeddedRulePrefix, rules);
