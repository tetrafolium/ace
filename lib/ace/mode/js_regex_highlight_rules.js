  ...
  var JsRegexHighlightRules = function() {
    this.$rules = {
      "start" : [
        ...
        {token : "regexp.keyword.operator", regex : escape}, {
          // flag
          token : "string.regexp",
          regex : "/\\w*",
          next : "start"
      ...
      "character_class" : [
        ...
        {token : "keyword", regex : escape},
        {token : "constant.language.escape", regex : "]", next : "start"},
        {token : "constant.language.escape", regex : "-"},
        {token : "empty", regex : "$", next : "start"},
        {defaultToken : "string.regexp.charachterclass"}
      ],
      "no_quantifier" : [
        {token : "invalid", regex : quantifier},
        {token : "invalid", regex : "", next : "start"}
      ]
