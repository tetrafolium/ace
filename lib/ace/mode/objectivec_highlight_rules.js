  ...
  var ObjectiveCHighlightRules = function() {
    ...
    this.$rules = {
      "start" : [
        ...
        {
          token :
              [ "punctuation.definition.keyword.objc", "keyword.other.objc" ],
          regex : "(@)(defs|encode)\\b"
        },
        {
        ...
        {
          token : [
            "punctuation.definition.storage.type.objc", "storage.type.objc"
          ],
        ...
        {token : "support.function.C99.c", regex : C_Highlight_File.cFunctions},
        {token : cObj.getKeywords(), regex : "[a-zA-Z_$][a-zA-Z0-9_$]*\\b"},
        {
      ...
      "constant_NSString" : [
        {token : "constant.character.escape.objc", regex : escapedConstRe},
      ...
      "bracketed_strings" : [
        ...
        {regex : escapedConstRe, token : "constant.character.escape.objc"},
