define(function(require, exports, module) {
  ...
  var RazorHighlightRules = function() {
    ...
    this.embedRules(RazorLangHighlightRules, "razor-block-", [ blockEndRule ],
                    [ "start" ]);
    this.embedRules(RazorLangHighlightRules, "razor-short-", [ shortEndRule ],
                    [ "start" ]);
