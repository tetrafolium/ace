...
define(function(require, exports, module) {
  ...
  function string(options) {
    return {
      ...
      regex : options.start,
      push : [
        {token : "constant.language.escape", regex : options.escape},
        {token : options.token + ".end", regex : options.start, next : "pop"},
  ...
  var VisualforceHighlightRules = function() {
    ...
    var hbs = {token : "keyword.start", regex : "{!", push : "Visualforce"};
