define(function(require, exports, module) {
  ...
  NodeList.prototype = {
     ...
     * @return Node
     * 	The node at the indexth position in the NodeList, or null if that is not
     * a valid index.
     */
   ...
   * imply that the DOM specifies an order to these Nodes. NamedNodeMap objects
   * in the DOM are live. used for attributes or DocumentType entities
   */
  ...
  DOMImplementation.prototype = {
    ...
    createDocument : function(
        ...
        doctype) { // raises:INVALID_CHARACTER_ERR,NAMESPACE_ERR,WRONG_DOCUMENT_ERR
    ...
    createDocumentType : function(
        ...
        systemId) { // raises:INVALID_CHARACTER_ERR,NAMESPACE_ERR
  ...
  Node.prototype = {
    ...
    removeChild : function(oldChild) { return _removeChild(this, oldChild); },
    appendChild : function(
        newChild) { return this.insertBefore(newChild, null); },
    hasChildNodes : function() { return this.firstChild != null; },
    cloneNode : function(
        deep) { return cloneNode(this.ownerDocument || this, this, deep); },
    // Modified in DOM Level 2:
    normalize : function() {
  ...
  Document.prototype = {
    ...
    // Introduced in DOM Level 2:
    importNode : function(
        importedNode, deep) { return importNode(this, importedNode, deep); },
    // Introduced in DOM Level 2:
  ...
  function Element() { this._nsMap = {}; };
  Element.prototype = {
    nodeType : ELEMENT_NODE,
    hasAttribute : function(
        name) { return this.getAttributeNode(name) != null; },
    getAttribute : function(name) {
      var attr = this.getAttributeNode(name);
      return attr && attr.value || '';
    },
    getAttributeNode : function(
        name) { return this.attributes.getNamedItem(name); },
    ...
    setAttributeNode : function(
        newAttr) { return this.attributes.setNamedItem(newAttr); },
    setAttributeNodeNS : function(
        newAttr) { return this.attributes.setNamedItemNS(newAttr); },
    removeAttributeNode : function(
        oldAttr) { return this.attributes.removeNamedItem(oldAttr.nodeName); },
    ...
    setAttributeNS : function(namespaceURI, qualifiedName, value) {
      var attr =
          this.ownerDocument.createAttributeNS(namespaceURI, qualifiedName);
      attr.value = attr.nodeValue = "" + value;
      this.setAttributeNode(attr);
    },
  ...
  CharacterData.prototype = {
    ...
    substringData : function(
        offset, count) { return this.data.substring(offset, offset + count); },
    appendData : function(text) {
      text = this.data + text;
      this.nodeValue = this.data = text;
      this.length = text.length;
    },
    insertData : function(offset, text) { this.replaceData(offset, 0, text); },
    appendChild : function(newChild) {
    ...
    deleteData : function(offset,
                          count) { this.replaceData(offset, count, ""); },
  ...
  function Comment() {};
  Comment.prototype = {nodeName : "#comment", nodeType : COMMENT_NODE} _extends(
    ...
    return XMLSerializer.prototype.serializeToString(this);
          ...
          serializeToString(node, buf) {
            ...
            case ELEMENT_NODE:
              ...
              if (child ||
                  isHTML && !/^(?:meta|link|img|br|hr|input|button)$/i.test(
                                nodeName)) {
                buf.push('>');
  ...
  function
  __set__(object, key, value) { object[key] = value; }
  // do dynamic
  function
  getTextContent(node) {
    switch (node.nodeType) {
    ...
    if (Object.defineProperty) {
      ...
      Object.defineProperty(Node.prototype, 'textContent', {
        get : function() { return getTextContent(this); },
        set : function(data) {
