define(function(require, exports, module) {
  ...
  function ClassList(node) { this.el = node; }
  (function() {
    this.add = function(str) { dom.addCssClass(this.el, str); };
    this.remove = function(str) { dom.removeCssClass(this.el, str); };
    this.toggle = function(str) { dom.toggleCssClass(this.el, str); };
    this.contains = function(str) { dom.hasCssClass(this.el, str); };
  ...
  (function() {
    this.__defineGetter__("nodeValue", function() { return this.value; });
  }).call(Attr.prototype);
  ...
  var initializers = {
    textarea : function() {
      ...
      this.value = "";
      this.select = function() { this.setSelectionRange(0, Infinity); };
    },
    style :
        function() { this.sheet = {insertRule : function() {}, cssRules : []}; }
  };
  ...
  (function() {
    ...
    this.cloneNode = function(recursive) {
      ...
      if (recursive) {
        this.children.forEach(
            function(ch) { clone.appendChild(ch.cloneNode(true)); }, this);
      }
      return clone;
    };
    this.appendChild = function(node) { return this.insertBefore(node, null); };
    ...
    this.remove =
        function() { this.parentNode && this.parentNode.removeChild(this); };
    ...
    this.hasChildNodes = function() { return this.childNodes.length > 0; };
    this.__defineGetter__("childElementCount",
                          function() { return this.childNodes.length; });
    this.hasAttributes =
        function() { return Object.keys(this.$attributes).length > 0; };
    ...
    this.querySelector = function(s) { return this.querySelectorAll(s)[0]; };
    ...
    this.removeAttribute = function(a) { delete this.$attributes[a]; };
    this.setAttribute = function(a, v) { this.$attributes[a] = v; };
    this.getAttribute = function(
        a, v) { return String(this.$attributes[a] || ""); };
    this.__defineGetter__("nodeName", function() { return this.localName; });
    this.__defineGetter__("tagName", function() { return this.localName; });
    ...
    this.__defineGetter__("className",
                          function() { return this.$attributes.class || ""; });
    this.__defineSetter__("className",
                          function(v) { this.$attributes.class = v; });
    ...
    this.__defineSetter__("innerText",
                          function(v) { throw new Error("use textContent"); });

    this.__defineGetter__("id", function() { return this.getAttribute("id"); });
    this.__defineSetter__("id", function(v) { this.setAttribute("id", v); });
      ...
      var attributes =
          this.attributes
              .map(
                  ...
                  this)
              .join(" ");
      return "<" + this.localName + (attributes ? " " + attributes : "") + ">" +
             this.innerHTML + "</" + this.localName + ">";
    });
    ...
    this.__defineGetter__(
        "lastChild",
        function() { return this.childNodes[this.childNodes.length - 1]; });
    this.__defineGetter__("firstChild",
                          function() { return this.childNodes[0]; });
    ...
    this.createEvent = function(v) { return new Event(); };
    ...
    this.blur = function() { document.body.focus(); };

    function removeAllChildren(node) {
      node.children.forEach(function(node) { node.parentNode = null; });
    ...
    selector.replace(
        ...
        function(_, hash, name, attr, attrValue) {
          if (hash == "#") {
            ...
            tests.push(function(
                node) { return node.getAttribute(attr) == attrValue; });
          } else if (_ == "*") {
            tests.push(function(node) { return true; });
          } else {
  ...
  function setInnerHTML(markup, parent, strict) {
    ...
    for (var m, lastIndex = 0; m = tagRe.exec(markup);) {
      ...
      if (encoded) {
        ...
        var attributes =
            markup.slice(tagRe.lastIndex, end - selfClosing).trim();
        ...
        if (m[1][0] !== "/") {
          ...
          attributes &&
              attributes.replace(
                  ...
                  function(
                      _, key, v1, v2,
                      v3) { root.setAttribute(key, v1 || v2 || v3 || key); });
        }
  ...
  (function() {
    this.initMouseEvent = function(type, _1, _2, window, detail, x, y, _x, _y,
  ...
  function TextNode(value) { this.data = value || ""; }
  (function() {
    this.nodeType = 3;
    this.ELEMENT_NODE = 1;
    this.TEXT_NODE = 1;
    this.cloneNode = function() { return new TextNode(this.data); };
    this.__defineGetter__("nodeValue", function() { return this.data; });
  }).call(TextNode.prototype);

  var window = {
    get innerHeight() { return WINDOW_HEIGHT; },
    get innerWidth() { return WINDOW_WIDTH; }
  };
  ...
  window.HTMLDocument = window.XMLDocument = window.Document = function() {
    ...
    document.createElementNS = function(ns, t) { return new Node(t); };
    document.createElement = function(t) { return new Node(t); };
    document.createComment =
        document.createTextNode = function(v) { return new TextNode(v); };
    document.createDocumentFragment =
        function() { return new Node("#fragment"); };
  ...
  window.requestAnimationFrame = function(
      callback) { return setTimeout(function() { callback(); }); };
  ...
  if (typeof Buffer != undefined) {
    ...
    window.atob = function(
        str) { return Buffer.from(str, "base64").toString("binary"); };
  }
  ...
  exports.load = function() {
    ...
    Object.keys(window).forEach(function(i) {
      if (!global[i]) {
        ...
        global.__defineGetter__(i, function() { return window[i]; });
  ...
  exports.loadInBrowser = function(global) {
    ...
    for (var i in window.document) {
      ...
      Object.defineProperty(
          global.document, i,
          {value : val, enumerable : true, configurable : true});
    }
  };
  ...
  exports.unload = function() {
    ...
    addedProperties.forEach(function(i) { delete global[i]; });
  };
