...
exports.parsePlist = function(xmlOrJSON, callback) {
  var json;
  if (xmlOrJSON[0] == "<") {
    plist.parseString(xmlOrJSON, function(_, result) { json = result[0]; });
  } else {
    try {
...
exports.formatJS = function(
    object, initialIndent) { return formatJS(object, 4, initialIndent); };
