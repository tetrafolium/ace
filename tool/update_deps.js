...
var deps = {
  ...
  jshint : {
    ...
    postProcess : function(src) {
      ...
      src = src.replace(/var defaultMaxListeners = 10;/,
                        function(a) { return a.replace("10", "200") });
      return src;
    }
  },
  emmet : {
  ...
  vim : {
    fetch : function() {
      var rootHref =
          "https://raw.githubusercontent.com/codemirror/CodeMirror/master/"
      var fileMap = {
        "keymap/vim.js" : "keyboard/vim.js",
        "test/vim_test.js" : "keyboard/vim_test.js"
      };
      async.forEach(Object.keys(fileMap),
                    function(x, next) {
  ...
  liveScript : {
    ...
    url :
        "https://raw.githubusercontent.com/gkz/LiveScript/master/lib/mode-ls.js"
  },
  coffee : {
  ...
  xmldom : {
    fetch : function() {
      var rootHref =
          "https://raw.githubusercontent.com/iDeBugger/xmldom/master/"
      var fileMap = {
      ...
      async.forEach(
          ...
          function(x, next) {
            download(
                rootHref + x,
                function(e, d) { fs.writeFile(rootDir + fileMap[x], d, next) })
          },
          function() { console.log("XmlDOM updating done") });
    }
  },
};
...
function dereqire(src) {
  return require("derequire")(
      src,
      [ {from : 'require', to : '_dereq_'}, {from : 'define', to : '_defi_'} ]);
}
...
function browserify(_, cb) {
  ...
  function done() {
    ...
    var defaultPreludePath =
        Path.join(require.resolve("browser-pack"), "../prelude.js");
    var defaultPrelude =
        "module.exports = " +
        fs.readFileSync(defaultPreludePath, 'utf8')
            .replace(/^[ \t]*\/\/.*/gm, "")
            .replace(/^\s*\n\r?/gm, "")
...
args.forEach(function(key) { getDep(deps[key]) });
